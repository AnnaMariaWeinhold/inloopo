...
<nav class="navbar">
    ...
    <ul class="navbar__ul">
       <li class="sub-navbar__dropdown">
        ...
        <label for="sub-navbar__checkbox" class="navbar__li">Products</label>
            <ul class="sub-navbar">
                <li class="navbar__li"><a class="link" href="investment">Signal Service</li>
                <li class="navbar__li"><a class="link" href="wikifolio">Managed Account</li>
            </ul>
        </li>
        <li class="navbar__li"><a class="link" href="about">About</a></li>
        <li class="navbar__li"><a class="link" href="contact">Contact</a></li>
        <li class="navbar__button"><a href="e-book-coming-soon">Free E-Book</a></li>
        <li class="navbar__li  navbar__lang"><a class="link" href="/de/">DE</a></li>
    </ul>
</nav>
</header>
`
...
customElements.define('main-navbar-en', MainNavBar);